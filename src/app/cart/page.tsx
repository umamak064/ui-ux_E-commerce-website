    ...
    <>
      ...
      <div className="flex flex-col md:flex-row justify-center items-start gap-3 mt-9">
        ...
        <div className="w-full h-full md:w-[700px] md:h-[500px] border rounded-[20px] ">
          {cartItem.map((item) => {
            return (
              <div key={item.id} className="flex justify-between mt-4 p-4 border-b"> {/* Added key={item.id} */}
        ...
        <div className="w-full md:w-[500px] h-full md:h-[450px] border rounded-[20px] flex flex-col justify-start items-center p-4">
          <div className="w-[90%] space-y-3 ">
            ...
            <p className="flex justify-between text-gray-400">
              Discount (-20%)<span className="font-bold text-black">-$113</span>
            </p>
            <p className="flex justify-between text-gray-400 mb-4 border-b">
            ...
            <div className="flex justify-between ">
              <input
                ...
                className="bg-[#F0F0F0] w-[250px] md:w-full text-gray-400 rounded-[62px] py-1 px-5 outline-none "
              />
