...
export default function Footer(){
    return(
        <main className="bg-[#F0F0F0] relative p-7 md:px-12 w-full h-full   md:h-[400px] flex flex-col  justify-start items-center relative mt-32 max-w-screen-2xl mx-auto">
        ...
        <div className="w-full h-[60%] flex flex-col md:flex-row justify-between items-start mt-52  md:mt-20 border-b-2 pb-5">
             ...
             {/* box 2 */}
             <div>
                <h2 className="text-xl mt-4 mb-2">Help</h2>
                <ul  className="space-y-2 text-gray-400">
             ...
             <div className="space-y-1 mt-4">
                <h2 className="text-xl mb-2">FAQ</h2> <ul className="space-y-2 text-gray-400" >
        ...
        <div className=" w-full flex flex-col md:flex-row items-center mt-5 md:mt-7 justify-between">
            <p className="text-xs md:text-sm">Shop.co © Made by umama khan,  All Rights Reserved</p>
