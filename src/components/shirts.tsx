...
export default function CasualShirts() {
  return (
    ...
    <h4 className="text-end text-gray-400">Showing 1-10 of 100 Products  Sort by: <span className="font-bold text-black"><select className="font-bold text-black" defaultValue="most-popular">
